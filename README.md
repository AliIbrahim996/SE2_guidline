...
* * *
 ...
 Follow these instructions in order to install XAMPP
  ...
  4. **Choose software components**:
     ...
     \
      &nbsp;
  5. **Choose the installation directory** _`Let the default path as shown`_:
     \
      &nbsp;
...
- You may install Laravel Sanctum via the Composer package manager so open Command-Prompt as an administrator and run this command:
  
  ```sh
    composer global require laravel/sanctum
  ```
...
**_[Our course repo](https://github.com/AliIbrahim996/SE2_guidline.git)_**
\
&nbsp;
